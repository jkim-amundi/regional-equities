...
DEFAULT_XLSX = Path(__file__).with_name('Template_HP_filter_INPUT_31122025.xlsx')
DEFAULT_LOGO = Path(__file__).with_name('Logo_Amundi_investment_solutions_4c.jpg')
