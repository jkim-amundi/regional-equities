...
# Config / constants
# -------------------------
DATA_FOLDER = "/home/coder/project/Regional_equity_app"
os.makedirs(DATA_FOLDER, exist_ok=True)

LOGO_PATH = os.path.join(DATA_FOLDER, "Logo_Amundi_investment_solutions_4c.jpg")
...
# Load model
model = lgb.Booster(model_file=os.path.join(DATA_FOLDER, 'LTR_final_model_EMU_UK_EPU.txt'))
...
""") as demo:
    ...
    gr.Markdown("# Cross-Asset Research - Regional Equity Tactical Allocation Recommendation")
    ...
    predict_btn = gr.Button("Predict Rank")
